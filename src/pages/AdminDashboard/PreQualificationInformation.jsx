...
import PreQualificationSummary from '../../Components/SummaryComponents/PreQualificationSummary'

function PreQualificationInformation(props) {
  return (
    <>
      <div className=" px-3 mb-5">
        <InformationContainer content="property" />
        <InformationTabs />
        <InformationBar headingBar="Pre-Qualification" imgBar={<img src="/assets/icons/circle-plus.png" alt="" />} contentBar="Add another borrower" />
...
export default PreQualificationInformation