...
import PrimarySummary from '../../Components/SummaryComponents/PrimarySummary'

function PrimaryHouseInformation(props) {
  return (
    <>
      <div className=" px-3 mb-5">
        <InformationContainer content="property" />
        <InformationTabs />
        {/* <InformationBar headingBar="Primary Housing Expense" imgBar={<img src="/assets/icons/circle-plus.png" alt="" />} contentBar="Add New Primary Housing Expense" />  */}
        <PrimarySummary/>
...
export default PrimaryHouseInformation