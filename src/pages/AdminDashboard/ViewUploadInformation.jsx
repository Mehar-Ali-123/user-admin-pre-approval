...
function ViewUploadInformation(props) {
  return (
    <>
      <div className=" px-3 mb-5">
        <InformationContainer content="property" />
        <InformationTabs />
        <InformationBar headingBar="Borrower Information" imgBar={<img src="/assets/icons/circle-plus.png" alt="" />} contentBar="Add New Employment Income" />
...
export default ViewUploadInformation