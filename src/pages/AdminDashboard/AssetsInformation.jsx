...
import AssetsSummary from '../../Components/SummaryComponents/AssetsSummary'

function AssetsInformation(props) {
  return (
    <>
      <div className=" px-3 mb-5">
        <InformationContainer content="property" />
        <InformationTabs />
        {/* <InformationBar headingBar="Assets" imgBar={<img src="/assets/icons/circle-plus.png" alt="" />} contentBar="Add New Assets" /> */}
        <AssetsSummary />
