...
function Redirect() {
  ...
  if (loading) {
    return (
      <div
        ...
        className="flex align-items-center justify-content-center flex-column gap-4"
      >
        <ProgressSpinner
  ...
  <Route path='/' element={<DashboardLayout />}>
    ...
    <Route path='/loan-application/declaration-loan' element={<DeclarationLoanInformation />} />
                ...
                element={
                  <Routes>
                    <Route path="/" element={<DashboardLayout />}>
                      ...
                      />
                      <Route
                        path="/application/income-information"
                        element={<IncomeInformation />}
                      />
                      <Route
                        path="/application/primary-information"
                        element={<PrimaryHouseInformation />}
                      />
                      <Route
                        path="/application/subj-query-information"
                        element={<SubjQueryInformation />}
                      />
                      <Route
                        path="/application/assets-information"
                        element={<AssetsInformation />}
                      />
                      <Route
                        path="/application/liability-information"
                        element={<LiabilityInformation />}
                      />
                      <Route
                        path="/application/pre-qualification-information"
                        element={<PreQualificationInformation />}
                      />
                      <Route
                        path="/application/upload-information"
                        element={<DocUploadInformation />}
                      />
                      <Route
                        path="/application/view-doc-information"
                        element={<ViewUploadInformation />}
                      />
                      <Route
                        path="/application/status-information"
                        element={<StatusInformation />}
                      /> 
                      <Route
                        path="/application/condition-application"
                        element={<ConditionInformation />}
                      /> 
                      <Route
                        path="/application/pre-approval-application"
                        element={<PreApprovalInformation />}
                      /> 
                      <Route
                        path="/loan-application/general-loan"
                        element={<GeneralLoanInformation />}
                      />
                      <Route
                        path="/loan-application/address-loan"
                        element={<AddressLoanInformation />}
                      />
                      <Route
                        path="/loan-application/income-loan"
                        element={<IncomeLoanInformation />}
                      />
                      <Route
                        path="/loan-application/reo-loan"
                        element={<ReoLoanInformation />}
                      />
                      <Route
                        path="/loan-application/liabilities-loan"
                        element={<LiabilitiesLoanInformation />}
                      />
                      <Route
                        path="/loan-application/decalaration-loan"
                        element={<DeclarationLoanInformation />}
                      />
                      <Route
                        path="/loan-application/assets-loan"
                        element={<AssetsLoanInformation />}
                      />
                      <Route
                        path="/loan-application/monitoring-loan"
                        element={<MonitoringLoanInformation />}
                      />
                    </Route>
